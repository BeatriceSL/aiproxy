...
def generate_together(
    ...
    Args:
        model (str): The model to use. Check the Together API for the list of models.
        messages (List[Dict[str, str]]): The messages to generate code from.
        ...
        streaming (bool, optional): Whether to stream the output or not. Defaults to False.
